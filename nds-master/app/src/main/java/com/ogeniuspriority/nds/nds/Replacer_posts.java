...
public class Replacer_posts {
    ...
    public static CharSequence replace(CharSequence source, String regex,
        ...
        return new Replacer_posts(source, matcher, replacement).doReplace();
    }

    private Replacer_posts(CharSequence source, Matcher matcher,
                           CharSequence replacement) {
        mSource = source;
