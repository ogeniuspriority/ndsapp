 ...
 */
public class My_Q_S_Comments_data_parser extends AsyncTask<Void, Void, Boolean> {
    Context c;
    String jsonData;
    ...
    public My_Q_S_Comments_data_parser(Context c, String jsonData) {
        this.c = c;
                        ...
                        if (db.save_A_NOTIFICATION(uniqueID, Notif_title_queries[i],
                            ...
                            new Thread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    Looper.prepare();
                                    final String theAvatarValue = new NDS_main(). FindThisTrickyAvatar(origin_remote_id_queries[finalI], "notif_using_query");
