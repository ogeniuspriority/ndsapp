...
public class LazyAdapter_for_new_suggests_preview extends BaseAdapter {
	...
	public LazyAdapter_for_new_suggests_preview(Activity a, String[] Images, String[] Names, String[] Time, String[] Posts) {
		activity = a;
		Images_local = Images;
		Names_local = Names;
		Time_local = Time;
