 ...
 */
public class My_Community_GetActivationCode_Connector {
    public static HttpURLConnection connect(String urlAddress,String MyRemoteId, String number_field) {
        ...
        try {
            ...
            data += "&" + URLEncoder.encode("number_field", "UTF-8") + "="
                    + URLEncoder.encode(number_field, "UTF-8");
