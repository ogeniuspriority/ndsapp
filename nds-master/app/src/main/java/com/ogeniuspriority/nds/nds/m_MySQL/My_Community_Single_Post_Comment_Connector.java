 ...
 */
public class My_Community_Single_Post_Comment_Connector {
    public static HttpURLConnection connect(String urlAddress,String FirstId, String posterId,String postParentId) {
        ...
        try {
            ...
            data = URLEncoder.encode("select_directive", "UTF-8")
                    + "=" + URLEncoder.encode("allposts", "UTF-8");
            ...
            data += "&" + URLEncoder.encode("postParentId", "UTF-8") + "="
                    + URLEncoder.encode(postParentId, "UTF-8");
