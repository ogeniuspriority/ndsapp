...
public class CropImageActivity extends MonitoredActivity {
    ...
    private void loadInput() {
        ...
        if (sourceUri != null) {
            ...
            try {
                ...
                rotateBitmap = new RotateBitmap(BitmapFactory.decodeStream(is, null, option), exifRotation,getPath(sourceUri));
                //--------------------
    ...
    private void onSaveClicked() {
        ...
        if (croppedImage != null) {
            imageView.setImageRotateBitmapResetBase(new RotateBitmap(croppedImage, exifRotation,null), true);
            imageView.center();
    ...
    private void saveImageToLocalStore(Bitmap finalBitmap) {
        ...
        //--------------
        File direct = new File(Environment.getExternalStorageDirectory() + "/Boo_images");

        if (!direct.exists()) {
            direct = new File("/Boo_images");
            direct.mkdirs();
        }
        String filename = "boo_img_" + cal.getTimeInMillis() + ".png";
        ...
        try {
            ...
            out.flush();
            out.close();
            //Toast.makeText(getBaseContext(), Environment.getExternalStorageDirectory().toString() + filename, Toast.LENGTH_SHORT).show();
            android.util.Log.w("Dirimage", "Saved!" + Environment.getExternalStorageDirectory().toString() + filename);
            //----------------------------
            //saveImageToLocalStore(rotateBitmap(Environment.getExternalStorageDirectory().toString() + filename));


            //-------------------------------------------
        } catch (Exception e) {
            e.printStackTrace();
            android.util.Log.w("DirImage", "failed!" + e.toString());
        }
    }
