 ...
 */
public class My_Community_Posts_CustomAdapter extends BaseAdapter {
    Context c;
    ...
    public My_Community_Posts_CustomAdapter(Context c, ArrayList<My_Community_Posts> my_Community_Posts_) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            //--------------------------
            post_Data.setText((posts.getMy_Posts_Poster_Post().contains("NDS_posts_img"))?"Image Not Supported on Phones":posts.getMy_Posts_Poster_Post());
