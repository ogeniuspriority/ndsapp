 ...
 */
public class My_Community_Comments_Retreive_Downloader_old extends AsyncTask<Void, Void, String> {
    Context c;
    String urlAddress;
    ...
    public My_Community_Comments_Retreive_Downloader_old(Context c, String urlAddress, ListView forum_whisper, SwipeRefreshLayout swipe_view,
    ...
    private String downloadData() throws UnsupportedEncodingException {
        ...
        HttpURLConnection con = My_Community_Comments_Retreive_Connector_old.connect(urlAddress,PostID);
        if (con == null) {
            return null;
        }
        try {
