 ...
 */
public class My_Community_Upload_audio extends AsyncTask<Void, Void, String> {
    Context c;
    ...
    public My_Community_Upload_audio(Context c, String selectedPath,
                                     String uploadedfile,
    ...
    protected void onPreExecute() {
        ...
        mProgressDialog.setTitle("Sending Audio suggestion...");
...
//        });
    ...
    private String doFileUpload_image() throws IOException {
        ...
        String jsonString = "";
        String urlString = Config.NDS_COMMUNITY_SUGGEST_AUDIO;
