 ...
 */
public class My_Community_Upload_video extends AsyncTask<Integer, Integer, String> {
    Context c;
    ...
    public My_Community_Upload_video(Context c, String selectedPath,
                                     String uploadedfile,
    ...
    protected void onPreExecute() {
        ...
        mProgressDialog.setTitle("Sending Video suggestion...");
...
//        });
    ...
    protected void onProgressUpdate( final  Integer... values) {
       ...
       // mProgressDialog.setTitle("Sending Video suggestion..."+values[0]*100/values[1]+"%");
        try {
            mProgressDialog.setProgress(values[0]);
            Log.w("value",""+values[0]);
        }catch (RuntimeException jjb){
    ...
    private String doFileUpload_image() throws IOException {
        ...
        String jsonString = "";
        String urlString = Config.NDS_COMMUNITY_SUGGEST_VIDEO;
        ...
        try {
            ...
            while (bytesRead > 0) {
                ...
                //mProgressDialog.setTitle("Sending Video suggestion..."+percentage+"%");
