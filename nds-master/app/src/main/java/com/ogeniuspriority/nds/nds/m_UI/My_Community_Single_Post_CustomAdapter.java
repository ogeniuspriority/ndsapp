 ...
 */
public class My_Community_Single_Post_CustomAdapter extends BaseAdapter {
    Context c;
    ...
    public My_Community_Single_Post_CustomAdapter(Context c, ArrayList<My_Community_Posts> my_Community_Posts_) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if (posts.getMy_Posts_Poster_id() == Integer.parseInt(View_NDS_posts_comments.MYRemoteId)) {
                delete_this_post.setVisibility(View.VISIBLE);
                delete_this_post.setTag(posts.getMy_Posts_Post_id());
            } else {
            ...
            //-------------------open the intent to finalize-------------------
            Intent intent = new Intent(c, NDS_posts_comments.class);
            //------------all this comes from the server----------
            //--------------Display a progress beacon----------

            String[] MyPostData_to_send = new String[]{poster_name.getText().toString(),
            ...
            intent.putExtra("MyPostData", MyPostData_to_send);
