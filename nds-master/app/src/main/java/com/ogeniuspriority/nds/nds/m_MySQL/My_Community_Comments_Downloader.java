 ...
 */
public class My_Community_Comments_Downloader extends AsyncTask<Void, Void, String> {
    Context c;
    String urlAddress;
    ListView forum_whisper;
    SwipeRefreshLayout swipe_view;

    public My_Community_Comments_Downloader(Context c, String urlAddress, ListView forum_whisper, SwipeRefreshLayout swipe_view) {
        this.c = c;
    ...
    private String downloadData() throws UnsupportedEncodingException {
        ...
        HttpURLConnection con = My_Community_Posts_Connector.connect(urlAddress,"","");
        if (con == null) {
            return null;
        }
        try {
