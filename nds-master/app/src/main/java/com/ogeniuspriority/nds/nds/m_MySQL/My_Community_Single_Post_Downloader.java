 ...
 */
public class My_Community_Single_Post_Downloader extends AsyncTask<Void, Void, String> {
    Context c;
    String urlAddress;
    ...
    public My_Community_Single_Post_Downloader(Context c, String urlAddress, ListView forum_whisper, String firstId, String posterId, ProgressDialog progress, String parentPostId) {
        this.c = c;
